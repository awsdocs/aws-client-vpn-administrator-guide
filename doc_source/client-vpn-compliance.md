# Compliance validation for AWS Client VPN<a name="client-vpn-compliance"></a>

Third\-party auditors assess the security and compliance of AWS Client VPN as part of multiple AWS compliance programs\. These include SOC, PCI, HIPAA, and others\.
