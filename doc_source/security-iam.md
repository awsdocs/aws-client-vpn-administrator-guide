# Identity and Access Management for AWS Client VPN<a name="security-iam"></a>
...
**IAM administrator** – If you're an IAM administrator, you might want to learn details about how you can write policies to manage access to Client VPN\. To view example Client VPN identity\-based policies that you can use in IAM, see [Identity\-based policy examples for AWS Client VPN](security_iam_id-based-policy-examples.md)\.
